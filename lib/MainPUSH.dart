...
class PushWebScreenTWO extends StatefulWidget {
  String loadURL;

   PushWebScreenTWO({super.key,  required this.loadURL});
  @override
  State<PushWebScreenTWO> createState() => _PushWebScreenTWOState(loadURL);
}

class _PushWebScreenTWOState extends State<PushWebScreenTWO> {
  _PushWebScreenTWOState(this.mainUrl);
  ...
  Future<void> _sendRawAppsFlyerDataToWeb() async {
    final data = {
      "content": {
        ...
        "app_name": "indicricket",
        "deep": null,
        "bundle_identifier": "com.koilktoil.plunkoballpong",
        "app_version": "1.0.0",
        "apple_id": "6739503199",
